...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/brianmario/mysql2/issues", "changelog_uri" => "https://github.com/brianmario/mysql2/releases/tag/0.5.5", "documentation_uri" => "https://www.rubydoc.info/gems/mysql2/0.5.5", "homepage_uri" => "https://github.com/brianmario/mysql2", "msys2_mingw_dependencies" => "libmariadbclient", "source_code_uri" => "https://github.com/brianmario/mysql2/tree/0.5.5" } if s.respond_to? :metadata=
