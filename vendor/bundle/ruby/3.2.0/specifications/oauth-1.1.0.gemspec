...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<oauth-tty>.freeze, ["~> 1.0", ">= 1.0.1"])
  ...
  s.add_development_dependency(%q<rubocop-lts>.freeze, ["~> 18.0"])
  s.add_development_dependency(%q<typhoeus>.freeze, [">= 0.1.13"])
  s.add_development_dependency(%q<webmock>.freeze, ["<= 3.19.0"])
end
